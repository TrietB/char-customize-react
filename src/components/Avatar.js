...
function Avatar({body,eyes,hair,mouth,eyebrows,glasses,noses,clothing1,clothing2,clothing3}) {
  return (
    <div className='avatar'>
        ...
        <Part path={"mouths"} index={mouth} zIndex={5} ></Part>
        ...
        <Part path={"clothes/layer_1"} index={clothing1} zIndex={5} ></Part>
        <Part path={"clothes/layer_2"} index={clothing2} zIndex={6} ></Part>
        <Part path={"clothes/layer_3"} index={clothing3} zIndex={7} ></Part>
    </div>
  )
}
